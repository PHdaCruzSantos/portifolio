...
const Hero = () => {
  return (
    <section
      id="hero"
      className="relative min-h-screen w-full px-5 py-24 text-[var(--cv-ink)] sm:px-8 lg:px-10"
    >
      <div className="mx-auto grid w-full max-w-7xl gap-10 lg:grid-cols-[0.34fr_0.66fr] lg:gap-12">
        ...
        >
          <div className="relative w-fit">
            <WireGlobeMark className="h-40 w-40 text-[var(--cv-accent)] sm:h-52 sm:w-52" />
            <StarburstMark className="absolute -bottom-4 -right-8 h-16 w-16 text-[var(--cv-ink)]/55 sm:h-20 sm:w-20" />
          </div>
        ...
        >
          <header className="lg:col-span-2">
            ...
            <h1 className="max-w-5xl text-[clamp(3.4rem,9vw,8.6rem)] font-black uppercase leading-[0.78] tracking-[-0.095em]">
              ...
              Desenvolvedor
              <br />
              <span className="cv-outline-text">Full Stack</span>
            </h1>
          </header>
          ...
          <div className="space-y-7">
            ...
            <div className="border-t border-current/35 pt-7">
              ...
              <p className="mt-4 max-w-sm text-sm leading-snug text-current/82">
                Estudante de Sistemas de Informação na UFOP, focado em produtos
                web, APIs, automações, integrações e sistemas em produção com
                leitura clara de negócio.
              </p>
            </div>
