...
const milestones = [
    {
        ...
        description: "Início da graduação em Sistemas de Informação. Base em algoritmos, modelagem, estruturas de dados e fundamentos de computação.",
        icon: (
...
const JourneyTimeline = () => {
    return (
        <section id="journey" className="relative w-full max-w-6xl mx-auto px-4 py-20">
             <div className="absolute top-0 left-1/2 -translate-x-1/2 w-px h-full bg-gradient-to-b from-transparent via-teal-300/20 to-transparent hidden md:block" />
                ...
                {milestones.map((milestone, index) => (
                    ...
                    >
                        ...
                        <div className="flex-1 w-full md:w-1/2">
                            <div className="p-6 rounded-lg bg-[#0b1117]/70 border border-white/10 hover:border-teal-300/30 transition-colors backdrop-blur-sm relative group">
                        ...
                        {/* Center Node */}
                        <div className="relative z-10 hidden md:flex items-center justify-center w-8 h-8 rounded-full bg-[#080a0f] border-2 border-teal-300/50 shadow-[0_0_20px_rgba(45,212,191,0.2)]">
