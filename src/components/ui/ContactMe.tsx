...
const ContactMe = () => {
    ...
    return (
        <div className="w-full max-w-5xl mx-auto px-6 pb-20 pt-10 text-center">
            <p className="text-sm uppercase tracking-[0.28em] text-teal-300/80 mb-4">Contato</p>
            ...
            <div className="flex flex-wrap justify-center gap-8 md:gap-12">
                ...
                <MagneticButton 
                    ...
                    className="group w-20 h-20 md:w-24 md:h-24 bg-[#0e76a8]/10 rounded-lg border border-[#0e76a8]/30 hover:border-[#0e76a8] hover:bg-[#0e76a8]/20 hover:shadow-[0_0_30px_rgba(14,118,168,0.3)]"
                >
                ...
                <MagneticButton 
                    ...
                    className="group w-20 h-20 md:w-24 md:h-24 bg-white/5 rounded-lg border border-white/10 hover:border-white hover:bg-white/10 hover:shadow-[0_0_30px_rgba(255,255,255,0.1)]"
                >
                    <svg className="w-8 h-8 md:w-10 md:h-10 fill-current text-white group-hover:scale-110 transition-transform duration-300" viewBox="0 0 24 24">
                ...
                <div className="relative flex items-center group/email gap-4">
                    <MagneticButton 
                        ...
                        className="group w-20 h-20 md:w-24 md:h-24 bg-teal-300/10 rounded-lg border border-teal-300/30 hover:border-teal-300 hover:bg-teal-300/20 hover:shadow-[0_0_30px_rgba(45,212,191,0.25)] z-10"
                    >
                    ...
                    <button
                        ...
                        className={`
                            absolute left-full ml-4 md:ml-6 px-4 py-2 rounded-md backdrop-blur-md border shadow-xl flex items-center gap-2 transition-all duration-300
                            ${copied 
